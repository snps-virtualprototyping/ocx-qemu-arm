...
namespace ocx { namespace arm {
    ...
    static const reg g_regdb[] = {
        ...
        { UC_ARM64_REG_Q2,   0, 128, "Q2"  },
        { UC_ARM64_REG_Q3,   0, 128, "Q3"  },
        { UC_ARM64_REG_Q4,   0, 128, "Q4"  },
        { UC_ARM64_REG_Q5,   0, 128, "Q5"  },
        { UC_ARM64_REG_Q6,   0, 128, "Q6"  },
        { UC_ARM64_REG_Q7,   0, 128, "Q7"  },
        { UC_ARM64_REG_Q8,   0, 128, "Q8"  },
        { UC_ARM64_REG_Q9,   0, 128, "Q9"  },
        { UC_ARM64_REG_Q10,  0, 128, "Q10" },
        { UC_ARM64_REG_Q11,  0, 128, "Q11" },
        { UC_ARM64_REG_Q12,  0, 128, "Q12" },
        { UC_ARM64_REG_Q13,  0, 128, "Q13" },
        { UC_ARM64_REG_Q14,  0, 128, "Q14" },
        { UC_ARM64_REG_Q15,  0, 128, "Q15" },
        { UC_ARM64_REG_Q16,  0, 128, "Q16" },
        { UC_ARM64_REG_Q17,  0, 128, "Q17" },
        { UC_ARM64_REG_Q18,  0, 128, "Q18" },
        { UC_ARM64_REG_Q19,  0, 128, "Q19" },
        { UC_ARM64_REG_Q20,  0, 128, "Q20" },
        { UC_ARM64_REG_Q21,  0, 128, "Q21" },
        { UC_ARM64_REG_Q22,  0, 128, "Q22" },
        { UC_ARM64_REG_Q23,  0, 128, "Q23" },
        { UC_ARM64_REG_Q24,  0, 128, "Q24" },
        { UC_ARM64_REG_Q25,  0, 128, "Q25" },
        { UC_ARM64_REG_Q26,  0, 128, "Q26" },
        { UC_ARM64_REG_Q27,  0, 128, "Q27" },
        { UC_ARM64_REG_Q28,  0, 128, "Q28" },
        { UC_ARM64_REG_Q29,  0, 128, "Q29" },
        { UC_ARM64_REG_Q30,  0, 128, "Q30" },
        { UC_ARM64_REG_Q31,  0, 128, "Q31" },

        { UC_ARM64_REG_V0,   0, 128, "V0"  },
        { UC_ARM64_REG_V1,   0, 128, "V1"  },
        { UC_ARM64_REG_V2,   0, 128, "V2"  },
        { UC_ARM64_REG_V3,   0, 128, "V3"  },
        { UC_ARM64_REG_V4,   0, 128, "V4"  },
        { UC_ARM64_REG_V5,   0, 128, "V5"  },
        { UC_ARM64_REG_V6,   0, 128, "V6"  },
        { UC_ARM64_REG_V7,   0, 128, "V7"  },
        { UC_ARM64_REG_V8,   0, 128, "V8"  },
        { UC_ARM64_REG_V9,   0, 128, "V9"  },
        { UC_ARM64_REG_V10,  0, 128, "V10" },
        { UC_ARM64_REG_V11,  0, 128, "V11" },
        { UC_ARM64_REG_V12,  0, 128, "V12" },
        { UC_ARM64_REG_V13,  0, 128, "V13" },
        { UC_ARM64_REG_V14,  0, 128, "V14" },
        { UC_ARM64_REG_V15,  0, 128, "V15" },
        { UC_ARM64_REG_V16,  0, 128, "V16" },
        { UC_ARM64_REG_V17,  0, 128, "V17" },
        { UC_ARM64_REG_V18,  0, 128, "V18" },
        { UC_ARM64_REG_V19,  0, 128, "V19" },
        { UC_ARM64_REG_V20,  0, 128, "V20" },
        { UC_ARM64_REG_V21,  0, 128, "V21" },
        { UC_ARM64_REG_V22,  0, 128, "V22" },
        { UC_ARM64_REG_V23,  0, 128, "V23" },
        { UC_ARM64_REG_V24,  0, 128, "V24" },
        { UC_ARM64_REG_V25,  0, 128, "V25" },
        { UC_ARM64_REG_V26,  0, 128, "V26" },
        { UC_ARM64_REG_V27,  0, 128, "V27" },
        { UC_ARM64_REG_V28,  0, 128, "V28" },
        { UC_ARM64_REG_V29,  0, 128, "V29" },
        { UC_ARM64_REG_V30,  0, 128, "V30" },
        { UC_ARM64_REG_V31,  0, 128, "V31" },
